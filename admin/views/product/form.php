<div class="container mt-4">
    ...
    <form action="index.php?url=product-form-add-save" method="POST" class="row" enctype='multipart/form-data'>
        <div class="col-6">
            ...
            <div class="">
                <img width="200px" id="blah" src="https://thaihabooks.com/wp-content/themes/nhasachthaiha/assets/images/default-thumbnail.jpg" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="dm_id" aria-label="Default select example">
                    <option selected hidden>Danh mục</option>
